...
export default function Toolbar() {
  ...
  return (
    <div className="absolute left-1/2 bottom-4 z-10 flex -translate-x-1/2 items-center gap-2 rounded-xl border border-gray-700 bg-gray-900/90 px-3 py-2 shadow-lg backdrop-blur-sm">
